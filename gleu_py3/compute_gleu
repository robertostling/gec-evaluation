...
if __name__ == '__main__' :
    ...
    parser.add_argument("--tokenizer",
                        help="SpaCy tokenizer module",
                        type=str,
                        default=None)
    parser.add_argument("--tokenize-reference",
                        help="Tokenize not just hypothesis, but reference"
                             "+source too",
                        default=False,
                        action="store_true")
    ...
    gleu_calculator = GLEU(n=args.n,
            tokenizer=(tokenize if args.tokenize_reference else None))
    ...
    for hpath in args.hypothesis :
        ...
        hyp = [tokenize(line) for line in instream]
