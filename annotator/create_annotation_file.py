...
python3 annotator/create_annotation_file.py annotations/balanced_A/robert.json data/balanced_test/Nyberg.CEFR_A.balanced_test.orig.txt data/balanced_test/Nyberg.CEFR_A.balanced_test.corr.txt data/balanced_test/Nyberg.CEFR_A.balanced_test.granska data/balanced_test/Nyberg.CEFR_A.balanced_test.mt data/balanced_test/Nyberg.CEFR_A.balanced_test.s2 data/maximal_paraphrase/Nyberg.CEFR_A.balanced_test.corr_MW.txt data/minimal_paraphrase/Nyberg.CEFR_A.balanced_test_Marie.txt 

python3 annotator/create_annotation_file.py annotations/balanced_A/katarina.json data/balanced_test/Nyberg.CEFR_A.balanced_test.orig.txt data/balanced_test/Nyberg.CEFR_A.balanced_test.corr.txt data/balanced_test/Nyberg.CEFR_A.balanced_test.granska data/balanced_test/Nyberg.CEFR_A.balanced_test.mt data/balanced_test/Nyberg.CEFR_A.balanced_test.s2 data/maximal_paraphrase/Nyberg.CEFR_A.balanced_test.corr_MW.txt data/minimal_paraphrase/Nyberg.CEFR_A.balanced_test_Marie.txt 
